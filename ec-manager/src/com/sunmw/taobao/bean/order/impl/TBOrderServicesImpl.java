...
public class TBOrderServicesImpl extends HibernateDaoSupport implements
		TBOrderServices {
	static Logger logger = Logger.getLogger(TBOrderServicesImpl.class);
